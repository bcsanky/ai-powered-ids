...
| optional_lab_ground_truth | Opcionális inputok | PASS | létezik | data/lab/lab_ground_truth.csv |  |
| optional_lab_features | Opcionális inputok | PASS | létezik | data/lab/lab_features.csv |  |
| optional_conn | Opcionális inputok | PASS | létezik | data/lab/zeek/conn.log |  |
| optional_flows | Opcionális inputok | WARN | hiányzik | data/lab/flows.csv | A tényleges mérés előtt vagy közben kell előállítani. |
| optional_alerts | Opcionális inputok | PASS | létezik | data/wazuh/alerts.jsonl |  |
